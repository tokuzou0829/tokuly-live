                ...
                <DialogContent>
                  ...
                  <div className="space-y-4 py-4">
                    <div className="flex items-center justify-between">
                      <label className="text-sm font-medium">元のアスペクト比を維持</label>
                      <Switch
                    ...
                    <DialogClose asChild>
                      <Button className="w-full" onClick={() => onAddVideoSource("screen")}>
                        画面共有を開始
                      </Button>
                    </DialogClose>
                  </div>
            ...
            >
              ...
              <div className="flex gap-2">
                {(source.id.startsWith("video-") || source.isAnimated) && (
                  <Button variant="outline" size="sm" onClick={() => onToggleVideoLoop(source.id)}>
                    {source.loop ? "Loop: On" : "Loop: Off"}
                  </Button>
                )}
                <Button variant="outline" size="sm" onClick={() => onToggleCropping(source.id)}>
                ...
                <Button size="icon" variant="destructive" onClick={() => onRemoveSource(source.id)}>
                  ×
                </Button>
              </div>
            </div>
          ...
          {Object.entries(audioSources)
            ...
            .map(([sourceId, source]) => (
              ...
              >
                ...
                <Button size="icon" variant="destructive" onClick={() => onRemoveSource(sourceId)}>
                  ×
                </Button>
              </div>
            ))}
